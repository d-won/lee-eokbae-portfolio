...
const works = [
    {
        ...
        tag: '전통 이야기',
        coverColor: '#3A5A7C',
        image: 'https://covers.openlibrary.org/b/isbn/9791160947878-L.jpg',
    ...
    },
    {
        ...
        tag: '전통 이야기',
        coverColor: '#E8D5B7',
        image: 'https://covers.openlibrary.org/b/isbn/9788986621228-L.jpg',
    ...
    },
    {
        ...
        tag: '평화',
        coverColor: '#A8C5A0',
        image: 'https://covers.openlibrary.org/b/isbn/9780874869729-L.jpg',
    ...
    },
    {
        ...
        tag: '생활·학습',
        coverColor: '#D4C4A0',
        image: 'https://covers.openlibrary.org/b/isbn/9788986565133-L.jpg',
    ...
    },
    {
        ...
        tag: '전통 이야기',
        coverColor: '#C9A96E',
        image: 'https://covers.openlibrary.org/b/isbn/9788943307530-L.jpg',
    ...
    },
    {
        ...
        tag: '평화',
        coverColor: '#8FB5A2',
        image: 'https://covers.openlibrary.org/b/isbn/9788998751425-L.jpg',
    ...
    },
    {
        ...
        tag: '전통 이야기',
        coverColor: '#D5C0A5',
        image: 'https://covers.openlibrary.org/b/isbn/9788986621952-L.jpg',
    ...
    },
    {
        ...
        tag: '전통 이야기',
        coverColor: '#C5B8A5',
        image: 'https://covers.openlibrary.org/b/isbn/9788986621945-L.jpg',
    ...
    worksGrid.innerHTML = works.map(w => `
        <div class="work-card" data-category="${w.category}" data-id="${w.id}">
            <div class="work-image" style="background-color: ${w.coverColor}">
                ...
                <div class="work-fallback" style="display:none;">${w.title}</div>
...
function openModal(workId) {
    ...
    modalImg.onerror = function() {
        this.parentElement.innerHTML = `<div class="work-fallback" style="display:flex;width:100%;height:100%;min-height:300px;align-items:center;justify-content:center;font-family:var(--font-serif);font-size:1.5rem;color:var(--color-ink-light);background:${w.coverColor}">${w.title}</div>`;
    };
